...
exports.default = {
    data: new discord_js_1.SlashCommandBuilder().setName('loa').setDescription('Approve').addSubcommand(s => s.setName('approve').setDescription('Approve a pending LOA').addStringOption(o => o.setName('id').setDescription('LOA ID').setRequired(true).setAutocomplete(true))),
