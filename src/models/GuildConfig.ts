...
export interface IGuildConfig extends Document {
    ...
    logChannel?: string;
    staffRole?: string;
    adminRoles: string[];       // ← changed to array
    loaRole?: string;
    departments: string[];
    loaTypes: string[];
...
const GuildConfigSchema = new Schema<IGuildConfig>({
    ...
    logChannel: String,
    staffRole: String,
    adminRoles: { type: [String], default: [] },   // ← array
    loaRole: String,
    departments: {
        type: [String],
        default: ['General', 'Medical', 'Personal', 'Training', 'Other']
    },
    loaTypes: {
        type: [String],
        default: ['Full LOA', 'Partial LOA', 'Semi LOA', 'Extended Break']
    },
